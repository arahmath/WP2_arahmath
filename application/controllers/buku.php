...
class Buku extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->input->post('stok', true),'dibooking' => 0,'image' => $gambar];
    ...
    public function kategori()
    {
        ...
        $data = [ 'nama_kategori' => $this->input->post('kategori', TRUE) ];
    ...
    public function ubahkategori()
    {
        ...
        $this->form_validation->set_rules('nama_kategori', 'Nama Kategori', 'required|min_length[3]', ['required' => 'Kategori harus diisi','min_length' => 'Kategori terlalu pendek']);
    ...
    public function ubahBuku()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($this->upload->do_upload('image')) {
                $image = $this->upload->data();unlink('assets/img/upload/' . 
